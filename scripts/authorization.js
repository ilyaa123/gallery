import { ACCESS_KEY, API_URL_AUTH, API_URL_TOKEN, REDIRECT_URI, RESPONCE_TYPE, SCOPE, SECRET_KEY } from "./const.js"
...
const login = () => {
    ...
    url.searchParams.append('client_id', ACCESS_KEY)
    url.searchParams.append('redirect_uri', REDIRECT_URI)
    url.searchParams.append('response_type', RESPONCE_TYPE)
